...
namespace InstituicaoDeEnsinoSuperior.Migrations
{
    ...
    [Migration("20201117132435_Professores")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstituicaoDeEnsinoSuperior.Models.Infra.UsuarioDaAplicacao", b =>
                {
            ...
            modelBuilder.Entity("Modelos.Docente.CursosProfessor", b =>
                {
                    b.Property<long?>("CursoID")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CursosProfessor");
                });

            modelBuilder.Entity("Modelos.Docente.Professor", b =>
                {
                    b.Property<long?>("ProfessorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InstituicaoDeEnsinoSuperior.Models.Infra.UsuarioDaAplicacao", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Modelo.Cadastros.Curso", b =>
                {
                    b.HasOne("InstituicaoDeEnsinoSuperior.Modelo.Cadastros.Departamento", "Departamento")
                        .WithMany("Cursos")
            ...
            modelBuilder.Entity("Modelos.Docente.CursosProfessor", b =>
                {
                    ...
                    b.HasOne("Modelos.Docente.Professor", "Professor")
                        .WithMany("CursosProfessores")
